...
<div class="content">
	<div class="user">
					...
					<div class=tfmain_m>
						<div class=shoporder_mdiv>
							<div class=tfmain_mdivm id=step_2_address>
								...
								<p>地址： <input type="text" name="address" /></span></P>
		...
		<?php if(is_array($items)): foreach($items as $k=>$g): ?><ul>	
			  ...
			  <li class=orderm_zf><?php echo ($g[shop_price]*$g[num]); ?></li><div class=clear></div>
