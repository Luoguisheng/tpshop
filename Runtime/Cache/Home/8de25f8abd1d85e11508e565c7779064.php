...
<div class="position">
    ...
    <span>
        <a href=".">
            首页
        <?php if(is_array($cat)): foreach($cat as $key=>$c): ?><a href="">
...
<div id="detail_body">
    <div class="detail_l">
        <div class="detail_pic">
            <a href="javascript:;" onclick="window.open('gallery.php?id=9'); return false;">
                <img src="/Newthink/Public/upload/<?php echo ($row["goods_img"]); ?>" alt="<?php echo ($row["goods_name"]); ?>"
 ...
 <div class="detail_smallpic_header">
			<a href="javascript:" onmousedown="clickRight()" onmouseout="scrollStop()">
				...
				<img src="/Newthink/Public/Home/images/detail_header.gif" border="0">
			</a>
		</div>
		<div id="demo" class="detail_smallpic_body">
            ...
            <div class="detail_smallpic_footer">
                ...
                onmouseout="scrollStop()">
                    <img src="/Newthink/Public/Home/images/detail_footer.gif" border="0">
                </a>
            </div>
        </div>
        <div class="clear">
                ...
                <ul style="border-bottom: medium none;">
                    <li style="width: 260px; float: left; margin-right: 10px; margin-top: 5px;">
                        ...
                        <span style="text-decoration: line-through;">
                            ￥<?php echo ($row["market_price"]); ?>元
                        </span><br />
                        本店售价：：
                        <span>
                            <font color="red">￥<?php echo ($row["shop_price"]); ?>元</font>
                        </span>
                    </li>
...
<div style="margin-top:30px;"><a href="<?php echo U('Home/Flow/buy',array('goods_id'=>$row['goods_id']));?>"><img src="/Newthink/Public/Home/images/member_shop.gif" /></a></div>
        ...
        <div style="border: 1px solid rgb(204, 204, 204); background: transparent url(./images/ad/ads03.jpg) repeat scroll 0% 0%; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; width: 885px; height: 71px; color: rgb(102, 102, 102);">
            <ul style="padding-left: 10px;">
                ...
                <li style="overflow: hidden; width: 330px; float: right; height: 71px;">
                    <img src="/Newthink/Public/Home/images/ads03.gif">
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="detail_info_l_body">
            ...
            <div id="ECS_COMMENT">
                <div class="det_review">
                    <form action="" onsubmit="submitComment(this)" method="post"
            ...
            <?php if(is_array($comms)): foreach($comms as $key=>$c): ?><div class="review">
                    <div class="rev_t">
                        <div class="rev_t_user"><strong>邮箱：</strong><?php echo ($c["email"]); ?></div>
...
<div class="footert">
	<div class="footertl">
		<div class="footert_1"><img src="/Newthink/Public/Home/images/logo21.gif"></div>
		<div class="footert_2"> 抢购热线（9:00-18:00）
		  <p><img src="/Newthink/Public/Home/images/tel2.gif"></p>
		</div>
	</div>
	<div class="footertr">
