		...
		<dd >
			<a href="<?php echo U('Home/User/address');?>">收货地址</a>
                    ...
                    <div class="usermain">
						...
						<div class="userright">
				<div class="mainbt">我的订单</div>		
				<div class="shop">
					<ul class="shop_b">
						<li class="shop_color">订单号</li>

						<li class="cart_much">下单时间</li>
						<li class="cart_nu">订单总金额</li>
						<li class="shop_name">订单状态</li>
					...
					<?php if(is_array($ordinfo)): foreach($ordinfo as $key=>$o): ?><ul class="ulcollection">
						<li class="shop_color"><a href="user.php?act=order_detail&order_id=<?php echo ($item["order_id"]); ?>" class="f6"><?php echo ($o["ord_sn"]); ?></a></li>
						<li class="cart_much"><?php echo (date("y-m-d",$o["ordtime"])); ?></li>
						<li class="cart_nu"><?php echo ($o["money"]); ?></li>
						<?php if($o['paystatus']==1) {?>
						<li class="shop_name">已支付</li>
                        <?php } else if($o['paystatus']==0){?>
                        <li class="shop_name">未支付</li>
                        <?php }?>
						<!-- <li class="shop_oper"><font class="f6">删除</font></li> -->
						<div class="clear"></div>
